package clonegod.zookeeper.auth;
...
public class ZookeeperAuth implements Watcher {
	...
	/** 连接地址 */
	final static String CONNECT_ADDR = "192.168.1.201:2181,192.168.1.202:2181,192.168.1.203:2181";
	/** 测试路径 */
	...
	public void process(WatchedEvent event) {
		...
		System.out.println(logPrefix + "path:\t" + path);
